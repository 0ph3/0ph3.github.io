...
The full ```admin``` username is eventually extracted by appending valid characters for each subsequent character of username ```username[$regex]=^aa.*``` 
